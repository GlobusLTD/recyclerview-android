...
class SimpleCheckablePersonsAdapter extends Adapter<Person, SimpleCheckedViewHolder>
        implements ItemClickHelper.Callback<Person> {

    private final boolean mUseMultipleCheckedLayout;

    SimpleCheckablePersonsAdapter(@NonNull final Datasource<Person> datasource, final boolean useMultipleCheckedLayout) {
    ...
    public SimpleCheckedViewHolder onCreateViewHolder(@NonNull final LayoutInflater inflater,
                                                      ...
                                                      final int viewType) {
        final SimpleCheckedViewHolder viewHolder = (mUseMultipleCheckedLayout ?
                SimpleCheckedViewHolder.inflateMultipleChoice(inflater, parent) :
                SimpleCheckedViewHolder.inflateSingleChoice(inflater, parent));
