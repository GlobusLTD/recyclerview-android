...
import com.globusltd.recyclerview.choice.MultipleModalChoiceMode;
...
public class MultipleModalChoiceModeExampleActivity extends AppCompatActivity {

    private PersonsViewModel mViewModel;

    private RecyclerView mRecyclerView;
    private MultipleModalChoiceMode mChoiceMode;
    private ChoiceModeHelper<Person> mChoiceModeHelper;

    @Override
    protected void onCreate(@Nullable final Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_multiple_modal_choice_mode_example);
        ...
        mChoiceMode = new MultipleModalChoiceMode(actionMode, mModalChoiceModeListener, savedInstanceState);
    ...
    private final ModalChoiceModeListener mModalChoiceModeListener = new ModalChoiceModeListener() {
        ...
        private final Context mContext = MultipleModalChoiceModeExampleActivity.this;
